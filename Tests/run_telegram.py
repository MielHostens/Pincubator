...
def setterT(update: Update, context: CallbackContext, temp) -> None:
    """Send a message when the command /start is issued."""
    user = update.effective_user
    update.message.reply_text(fr'Setter temperature currently is {temp}')
    update.message.reply_markdown_v2(
...
def main() -> None:
    ...
    dispatcher.add_handler(CommandHandler("setterT", setterT))
